...
fn test_add_command_success() {
    ...
    cmd.arg("add")
        ...
        .arg("--amount").arg("-1000")
        .arg("--category").arg("Food")
        .arg("--account").arg("Cash");
...
fn test_add_command_with_memo() {
    ...
    cmd.arg("add")
        ...
        .arg("--category").arg("Food")
        .arg("--account").arg("Cash")
        .arg("--memo").arg("Lunch at restaurant");
...
fn test_add_command_with_positive_amount() {
    ...
    cmd.arg("add")
        .arg("--date").arg("2025-01-15")
        .arg("--amount").arg("50000")
        .arg("--category").arg("Salary")
        .arg("--account").arg("Bank")
        .arg("--memo").arg("Monthly salary");
...
fn test_list_command_with_transactions() {
    ...
    add_cmd2.arg("add")
        .arg("--date").arg("2025-01-02")
        .arg("--amount").arg("-2000")
        .arg("--category").arg("Transport")
        .arg("--account").arg("Bank");  // Use Bank instead of Card (default account)
...
fn test_transform_command_table() {
    ...
    transform_cmd.arg("transform")
        .arg("--program").arg("table");
    
    transform_cmd.assert()
        .success()
        .stdout(predicate::str::contains("Food"))
...
fn test_transform_command_group_by() {
    ...
    transform_cmd.env("XDG_DATA_HOME", temp_dir.path().join("data"));
    transform_cmd.arg("transform")
        .arg("--program").arg("(group-by table (lambda (pair) (cdr (assoc 'category (cdr pair)))))");
...
fn test_transform_command_invalid_program() {
    ...
    cmd.arg("transform")
        .arg("--program").arg("(invalid syntax");
...
fn test_add_command_invalid_date_format() {
    ...
    cmd.arg("add")
        .arg("--date").arg("01/01/2025")  // Wrong format, should be YYYY-MM-DD
        .arg("--amount").arg("-1000")
        .arg("--category").arg("Food")
        .arg("--account").arg("Cash");
...
fn test_transform_with_car_operation() {
    ...
    transform_cmd.env("XDG_DATA_HOME", temp_dir.path().join("data"));
    transform_cmd.arg("transform")
        .arg("--program").arg("(cons (car table) ())");
